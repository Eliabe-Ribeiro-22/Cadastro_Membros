...
<div class="conteudo">
    <div>
        ...
        <input type="text" name="cpf" id="cpf" maxlength="11" placeholder="12345678998" required value="{{$membro->cpf}}">
    </div>

    <div>
        <label for="rg">RG(somente números):</label>
        <input type="text" name="rg" id="rg" maxlength="9" placeholder="111111111" required value="{{$membro->rg}}">
    </div>
