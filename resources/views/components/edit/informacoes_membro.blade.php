<div id="info-membro">
    ...
    {{-- Guia complemento --}}
    <h3>{{ $membro->dataConversao }}</h3>
    <h3>{{ $membro->batismoAguas }}</h3>
    <h3>{{ $membro->dataBatismoAguas }}</h3>
    <h3>{{ $membro->batismoES }}</h3>
    <h3>{{ $membro->dataBatismoES }}</h3>
    <h3>{{ $membro->observacoes }}</h3>
</div>
